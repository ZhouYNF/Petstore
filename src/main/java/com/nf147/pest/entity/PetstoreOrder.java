...
public class PetstoreOrder {
    ...
    private PetstorePet petstorePet;
    ...
    public PetstorePet getPetstorePet() { return petstorePet; }

    public void setPetstorePet(PetstorePet petstorePet) { this.petstorePet = petstorePet; }
